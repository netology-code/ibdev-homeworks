...
**Важно**. Вам нужно вводить команду `ACL LOG`. По умолчанию будет выведено до 10 событий. Если вы введёте `ACL LOG RESET`, то лог будет очищен, и придётся повторять всю работу заново.
