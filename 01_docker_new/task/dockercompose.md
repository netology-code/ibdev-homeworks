...
2. Для этого проекта необходимо подготовить два файла в рабочем каталоге проекта. Перейдите в правый терминал и создайте пустые файлы `index.html` и `docker-compose.yml`. Выполните контрольную проверку их наличия в рабочем каталоге (необходимые команды вы уже применяли в предыдущих заданиях).

<img src="https://github.com/netology-code/ibdev-homeworks/blob/master/01_docker_new/pic/kali_6.png" width="600">

3. Сформируйте свой вариант файла титульной страницы для Nginx. Откройте файл `index.html` с помощью текстового редактора `mousepad` или другого на своё усмотрение. Скопируйте подготовленный код:
